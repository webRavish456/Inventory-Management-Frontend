...
export default function DeleteStaff({ deleteId, isDeleting, handleDelete, handleClose }) {
  ...
  return (
    <Dialog open={true} onClose={handleClose} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography>Are you sure you want to delete this staff (ID: {deleteId})?</Typography>
      </DialogContent>
      <DialogActions>
