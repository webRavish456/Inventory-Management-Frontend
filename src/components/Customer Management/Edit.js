...
export default function EditCustomer({ editData, handleUpdate, handleClose }) {
  const [customerData, setCustomerData] = useState({ ...editData });
  ...
  const handleSubmit = () => {
    if (handleUpdate) handleUpdate(customerData);
    handleClose();
  };
