...
export default function DeleteCustomer({ deleteId, isDeleting, handleDelete, handleClose }) {
  ...
  return (
    <Dialog open={true} onClose={handleClose} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Typography>Are you sure you want to delete this Customer (ID: {deleteId})?</Typography>
      </DialogContent>
      <DialogActions>
